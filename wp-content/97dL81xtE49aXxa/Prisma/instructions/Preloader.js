...
(function () {
	...
	Prisma.Preloader.prototype = {
		...
		preload: function () {
			...
			this.load.audio('panelUp', ['../assets/audio/panelIn.mp3', '../assets/audio/panelIn.ogg']);
			...
			this.load.image('instruction1','../assets/' + f.screen + '/instruction1.png');
			this.load.image('instruction2','../assets/' + f.screen + '/instruction2.png');
			this.load.image('instruction3','../assets/' + f.screen + '/instruction3.png');
			this.load.image('instruction4','../assets/' + f.screen + '/instruction4.png');
			this.load.image('instruction5','../assets/' + f.screen + '/instruction5.png');
			this.load.image('instruction6','../assets/' + f.screen + '/instruction6.png');
